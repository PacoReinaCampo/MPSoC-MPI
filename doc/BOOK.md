---
title: Message Passing Interface for a Multi-Processor System on Chip
author: QueenField
...
## 2.1. Message Passing Interface for a Processing Unit
...
| Core                       | Module description                      |
| -------------------------- | --------------------------------------- |
| `mpi_bb`                   | Message Passing Interface for Blackbone |
| `...mpi_buffer`            | MPI Buffer                              |
| `.....mpi_buffer_endpoint` | MPI Buffer Endpoint                     |
| `.......noc_buffer`        | Network on Chip Buffer                  |
